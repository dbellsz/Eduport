...
$qery = "SELECT   tblstudents.StudentName,tblstudents.RollId,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.RollId=:rollid and tblstudents.ClassId=:classid ";
$stmt = $dbh->prepare($qery);
$stmt->bindParam(':rollid',$RollId,PDO::PARAM_STR);
$stmt->bindParam(':classid',$results2,PDO::PARAM_STR);
$stmt->execute();
...
$query->bindParam(':classid',$results2,PDO::PARAM_STR);
$query-> execute();  
