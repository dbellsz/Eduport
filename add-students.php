...
$sql="INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,ClassId,DOB) VALUES(:studentname,:roolid,:studentemail,:gender,:classid,:dob)";
...
<html lang="en">
    <head>
        ...
        <title>Eduport| Register Student< </title>
